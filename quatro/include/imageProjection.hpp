...
private:
    ...
    //float startOrientation; // unused?
    //float endOrientation; // unused?

    quatro::msg::CloudInfo segMsg; // info of segmented cloud

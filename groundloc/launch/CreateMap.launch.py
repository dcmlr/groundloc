...
def setup(context):
	...
	if dataset_value == "helipr":
		if sensor_value.lower() == "ouster":
		    ...
		    base_link_velodyne_tf = launch_ros.actions.Node(
		        ...
		        executable='static_transform_publisher',
		        name='base_link_velodyne_tf_pub',
		        arguments=['0.0', '0.0', '2.0', '0.0', '-0.015595725680495854', '0.007271127000748835', #TODO: Aeva -> Ouster
		                   'base_link',
		                   'velodyne'])
		    ...
		    base_link_velodyne_tf = launch_ros.actions.Node(
		        ...
		        executable='static_transform_publisher',
		        name='base_link_velodyne_tf_pub',
		        arguments=['0.0', '0.0', '2.0', '0.0', '0.009958177597463428', '-0.017660507983823313', #TODO: Avia -> Ouster
		                   'base_link',
		                   'velodyne'])
		    ...
		    base_link_velodyne_tf = launch_ros.actions.Node(
		        ...
		        executable='static_transform_publisher',
		        name='base_link_velodyne_tf_pub',
		        arguments=['0.0', '0.0', '2.0', '0.0', '0.005542258713330074', '0.0056861114771429465', #TODO: Avia -> Ouster
		                   'base_link',
		                   'velodyne'])
	...
	return [map_utm_tf,
		...
		launch_ros.actions.Node(
                                package='groundloc',
								executable='collect_geotiff.py',
								name='collect_geotiff',
								output='screen',
								sigkill_timeout='60',
								parameters=[
...
def generate_launch_description():
	...
	# dataset sequence (00, 01, etc for Kitti, LiDAR type for HeLIPR: "Ouster", "Aeva", etc)
	...
	# delimiter for the pose files (generally space). 
